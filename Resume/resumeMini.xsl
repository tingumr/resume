...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   <xsl:import href="xslmini/header.xsl" />

   <xsl:import href="xslmini/summary.xsl" />

   <xsl:import href="xslmini/skills.xsl" />

   <xsl:import href="xslmini/workExperience.xsl" />

   <xsl:import href="xslmini/certifications.xsl" />

   <xsl:import href="xslmini/publications.xsl" />

   <xsl:import href="xslmini/education.xsl" />
   
   <xsl:import href="xslmini/personalInfo.xsl" />
